...
import (
	...
	admin_services "github.com/jolotech/jolo-mars/internal/services/admin"
...
type Container struct {
	...
	AdminAuthHandler *auth.AdminAuthHandler
...
func Init() *Container {
	...
	adminAuthService := admin_services.NewAdminAuthService(adminAuthRepo)
